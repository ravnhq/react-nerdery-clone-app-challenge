...
const SignUpForm = ({ onSubmit, error }: Props) => {
    ...
    return (
        <StyledSignUp onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
                <StyledLabel htmlFor="email">What's your email?</StyledLabel>
                <StyledInput
                    id="email"
                    type="text"
            ...
            <div>
                <StyledLabel htmlFor="password">Create a password</StyledLabel>
                <StyledInput
                    id="password"
                    type="password"
                    backgroundColor="transparent"
            ...
            <div>
                ...
                {errors.year && <ErrorLabel message="Enter a valid year." />}
            </div>
            <div>
                <StyledLabel htmlFor="date-of-birth">
                    What's your gender?
                ...
                {errors.gender && <ErrorLabel message="Select your gender." />}
            </div>
            <div>
